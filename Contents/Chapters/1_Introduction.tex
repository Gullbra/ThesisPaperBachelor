...
\begin{itemize}
  \item[] \textbf{RQ:} How does Convolutional Neural Network (CNN) compare to the RS-Analysis statistical test in accurately and reliably detecting LSB steganography in PNG images?
\end{itemize}
