...
The network was trained using the Adamax optimizer \cite{Kingma2014}, since \textcite{Boroumand2019} found it relieble with a fast convergence relative to other alternatives. 
