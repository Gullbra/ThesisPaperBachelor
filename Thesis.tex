...
\usepackage{parskip} % för att lägga till mellanrum mellan paragraferna
\usepackage{amsmath} % matematiska funktioner
\usepackage{graphicx}
...
\include{Contents/Chapters/1_Introduction}
\include{Contents/Chapters/2_Extended Background}
\include{Contents/Chapters/3_Method}
\include{Contents/Chapters/4_Results}
\include{Contents/Chapters/5_Discussion}
